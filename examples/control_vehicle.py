...
try:
    ...
    raise RuntimeError(
        'cannot import pygame, make sure pygame package is installed') from import_error
...
class HUD(object):
    ...
    def tick(self, world, clock):
        ...
        self.velocity = world.player.get_velocity()
        ...
        self._info_text = [
            ...
            '',
            'Speed:   % 15.0f km/h' % (
                calculate_speed_from_velocity(self.velocity)),
